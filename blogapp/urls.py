...
from .views import PostListView, PostDetailView, category_page, tag_page, PostCreate, PostUpdate, new_comment, CommentUpdate, delete_comment


app_name = 'blogapp'

urlpatterns = [
    path('delete_comment/<int:pk>/', delete_comment, name='delete'),
